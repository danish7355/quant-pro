...
export default function TradingChart({ coin, activePosition }: TradingChartProps) {
  ...
  useEffect(() => {
    ...
    // 5. Annotations Arrows for Crossovers
    const markers: any[] = [];
    ...
    if (activePosition) {
      ...
      if (activePosition.trailingStop !== null) {
        candlestickSeries.createPriceLine({
        ...
        <div className="flex flex-col justify-between p-1">
          ...
          <span className="text-gray-200">
            ...
            <span className="font-bold text-teal-400">
              ${coin.indicators.fib.levels['0.618']?.toLocaleString(undefined, { maximumFractionDigits: 3 })}
            </span>
          </span>
          <span className="text-[10px] text-gray-500">
            S/R:{' '}
